...
* **Full-stack web development** with a focus on performance
* **Algorithm optimization** for large-scale data processing

### Recent Achievements:
* Built **GDPR-compliant data management system** handling **10,000+ daily transactions**.
* Developed **AI voice assistant** reducing spam calls by **78%**.
* Optimized **Laravel applications** achieving **3x faster response times**.
